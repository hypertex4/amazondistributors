...
<head>
    ...
    <meta name="description" content="Amazon Distributors Admin Dashboard">
    <meta name="keywords" content="admin Dashboard, Amazon Distributors admin template, responsive Amazon Distributors admin dashboard, web app">
    <meta name="author" content="pixelstrap">
    <base href="http://localhost/amazondistributors/admin/">
    ...
    <title>Amazon Distributors - Admin Dashboard</title>
    ...
    <div class="page-main-header no-print-widget">
        <div class="main-header-left">
            <div class="logo-wrapper">
                <a href="dashboard">
                    <img class="blur-up lazyloaded" src="./assets/img/header_logo_one.png"  alt="">
                </a>
            </div>
        </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a class="sidebar-header" href="javascript:void(0)">
                            <i data-feather="box"></i><span>Pickup</span><i class="fa fa-angle-right pull-right"></i>
                        </a>
                        <ul class="sidebar-submenu">
                            <li><a href="schedule-pickup"><i class="fa fa-circle"></i>Schedule Pickup</a></li>
                            <li><a href="delivery-request"><i class="fa fa-circle"></i>Delivery Request</a></li>
                            <li><a href="transactions"><i class="fa fa-circle"></i>Payments</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="sidebar-header" href="javascript:void(0)">
                            <i data-feather="map-pin"></i><span>Manage Location</span><i class="fa fa-angle-right pull-right"></i>
                        </a>
                        <ul class="sidebar-submenu">
                            <li><a href="manage-location"><i class="fa fa-circle"></i>List Areas</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="sidebar-header" href="javascript:void(0)">
